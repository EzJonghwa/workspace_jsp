        ...
        <div class="col-lg-4">
          <form action="joinAction.jsp" method="post">   <!-- 위에 있던 .needs-validation 추가해준것.-->
            ...
            <div class="form-group">
              <input type="text" class="form-control" value="${user.userId}" disabled class="form-control" placeholder="아이디"  maxlength="20" >
              <input type="hidden" class="form-control" value="${user.userId}" class="form-control" placeholder="아이디" name="userId" maxlength="20" >  
              <div class="invalid-feedback">  <!-- 필수 입력요소 없을 때 메시지 출력해주는 div-->
                아이디는 필수입니다.
              </div>
            </div>
            <div class="form-group pt-1">
              <input type="password" class="form-control" value="${user.userPw}" disabled class="form-control" placeholder="비밀번호" name="userPw" maxlength="20" >
              <div class="invalid-feedback">
                비밀번호는 필수입니다.
              </div>
            </div>
            <div class="form-group pt-1" style="padding-bottom: 5%;">
              <input type="text" class="form-control" value="${user.userNm}" class="form-control" placeholder="이름" name="userNm" maxlength="20" >
              <div class="invalid-feedback">
                이름은 필수입니다.
              </div>
